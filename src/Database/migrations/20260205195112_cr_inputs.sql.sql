CREATE TABLE `inputs` (
	...
	`supplier_id` BIGINT(20) UNSIGNED NULL COMMENT 'ID do fornecedor',
	...
	INDEX `updated_by` (`updated_by`) USING BTREE,
    	CONSTRAINT `fk_category_id_categories_20260205195112_c26f36` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT `fk_supplier_id_suppliers_20260205195112_c26f36` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
